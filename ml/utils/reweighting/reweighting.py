...
# ===============================================================================
# ===============================================================================
def binned_1D_reweighting_test2(
    df_feature0,
    df_w0,
    df_feature1,
    df_w1,
    ...
    **kwargs,
    ...
    # multiply by the bin content to increase the weighting
    df_w0 = df_w0.divide(bin_content0, axis=0)  # can we do in-place?
    df_w1 = df_w1.divide(bin_content1, axis=0)
...
# ===============================================================================
# ===============================================================================
def binned_1D_reweighting_test3(
    df_feature0,
    df_w0,
    df_feature1,
    df_w1,
    ...
    **kwargs,
    ...
    nevent0_perbin = np.array([np.sum((bin_index0-1) == x) for x in range(len(hist0))])
    nevent1_perbin = np.array([np.sum((bin_index1-1) == x) for x in range(len(hist1))])

    hist0 /= nevent0_perbin
    hist1 /= nevent1_perbin
...
# ===============================================================================
# ===============================================================================
def binned_1D_reweighting_unbalance(
    df_feature0,
    df_w0,
    df_feature1,
    df_w1,
    ...
    **kwargs,
    ...
    hist0 = hist0.max()/hist0

    bin_content0 = hist0[bin_index0 - 1] * 10000 # shift by overflow bin
    bin_content1 = hist0[bin_index1 - 1] * 10000 # * hist_ratio[bin_index1 - 1]
