...
def arg_handler_train():
    ...
    parser.add_argument('-u', '--uniformise_features', action='store', type=str, dest='uniformise_features', default=None, help='Flatten the differential distribution of the user defined features (csv separated list)')
